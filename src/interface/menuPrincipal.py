...
layout = [
    ...
    [[sg.Text("ESCOLHA UM DOS ALGORÍTMOS: ", font=("Helvetica", 15)), sg.Button("FORÇA BRUTA", font=("Helvetica", 15)), sg.Button("BRANCH AND BOUND", font=("Helvetica", 15)), sg.Button("B&B ALTERNATIVO", font=("Helvetica", 15))]],
]
